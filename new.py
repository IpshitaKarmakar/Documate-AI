...
with st.sidebar:
    ...
    st.image("logo1.png.webp", use_column_width=True)
...
if choice == "🏠 Home":
    ...
    **Built using Open Source Stack (Llama 3.2, BGE Embeddings, and Qdrant running locally within a Docker Container.)**
    ...
    Enhance your document management experience with DocuMate AI! 😊
    """)

# Chatbot Page
elif choice == "🤖 Chatbot":
    st.title("🤖 Chat with Offline Genius")
    st.markdown("---")
...
# Contact Page
    ...
    st.title("📬 Contact Us")
    st.markdown("""
    I am Ipshita Karmakar, a B.Tech student at NIT Arunachal Pradesh, with a strong foundation in Python and machine learning.
    I have successfully developed various machine learning projects and am now exploring NLP and AI. 
    Currently, I am building a docuMate ai capable of processing PDF files offline which is highly secure to keep the data private. 
    This project represents my first step in integrating advanced AI techniques into practical applications            

    - **Email:** [ipshita.cse.22@nitap.ac.in](mailto:ipshita.cse.22@nitap.ac.in) ✉️
    - **GitHub:** [Project Uploaded in GitHub](https://github.com/IpshitaKarmakar) 🛠️

    Thank you IOCL Kolkata team for giving me this auspicious oppurunity for creating DocuMate AI.
    """)

# Footer
st.markdown("---")
st.markdown("© 2024 DocuMate AI by Ipshita Karmakar. All rights reserved. 🛡️")
